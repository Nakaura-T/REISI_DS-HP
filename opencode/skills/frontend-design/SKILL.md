...
description: Create distinctive, intentional visual design when building or redesigning web pages. Use for aesthetic direction, typography, layout, and a clear visual identity grounded in the user's actual content.
license: Complete terms in LICENSE.txt
metadata:
  source: https://github.com/anthropics/skills/tree/41bbe19d1a1a7eaab5e7bb9050a417e5c6cffc8f/skills/frontend-design
  adaptation: OpenCode project context and factual-brief clarification, 2026-09-10
---

# Frontend Design

Adapted from Anthropic's `frontend-design`. Modified on 2026-09-10: trigger description and opening brief clarification. Design guidance below is retained from the upstream skill. See `LICENSE.txt`.

Approach the work as a design lead giving this particular client a distinct visual identity. Make deliberate, opinionated choices about palette, typography, and layout that are specific to the brief, and take aesthetic risk if justified. Ground the brief in what the user actually said; do not invent a history of rejected proposals or approved directions.

For this project, first read `../../SITE_BRIEF.md` and the project-root `CONTENT_NOTES.md`. Use the existing HTML/CSS/JavaScript stack. Skill installation alone is not a request to redesign the website.
