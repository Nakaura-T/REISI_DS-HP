...
metadata:
  source: https://github.com/ibelick/ui-skills/blob/f5dd1de9c0fc6c033a43dc3fd2a5be41366e9f43/skills/fixing-motion-performance/SKILL.md
  adaptation: OpenCode invocation notes, 2026-09-10
---
...
Loaded by name in OpenCode when the task matches, or through the project's `/lab-review` command. The upstream `/fixing-motion-performance` command is not registered separately in this project.

Review the requested files against the rules below and report:
- violations (quote the exact line or snippet)
- why it matters (one short sentence)
- a concrete fix (code-level suggestion)

Do not migrate animation libraries unless explicitly requested. Apply rules within the existing stack. Read `../../SITE_BRIEF.md` for this site's context. Review-only requests do not authorize source changes.
